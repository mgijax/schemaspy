...
./buildSybaseDocs $host $port ${MGD_DBNAME} ${MGD_DBSERVER} ${DATALOADSOUTPUT}/mgi/schemaspy-$host
#./buildSybaseDocs rohan 4100 mgd DEV_MGI ${DATALOADSOUTPUT}/mgi/schemaspy-rohan
