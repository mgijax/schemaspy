...
#
# wrapper for call to 'buildSybaseDocs' with appropraite arguments
# uses mgiconfig variables
#
...
echo buildSybaseDocs $host $port ${MGD_DBSERVER} ${MGD_DBNAME} ${MGD_DBUSER} `cat ${MGD_DBPASSWORDFILE}` ${DATALOADSOUTPUT}/mgi/schemaspy-$host
